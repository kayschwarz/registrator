...
exports.attach = function (options) {
  ...
  this.register.update = function (provided, sender) {
    
    var http = sender,
        data = {};
        
    db.get(provided.number, function(err, registered) {
      // respond with error, if any
      if (err) {      
        // we just assume a 404
        var e = error[404];
        ...
        if (provided.mac !== registered.mac) {
        ...
        if (provided.pass !== registered.pass) {
